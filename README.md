...
This is an Android application that recognizes the denomination of Indian currency notes using a smartphone camera. This has been designed primarily to assist the visually impaired in identifying Indian currency notes. I created this while doing my internship at IIT Ropar. Here is the playstore link to it: https://play.google.com/store/apps/details?id=com.Roshni.ipsa.myapplication
